...
#define APP_COLOR               ([UIColor colorWithHexString:@"#A6D0FF"])
#define APP_COLOR_LIGHT         ([UIColor colorWithHexString:@"#A6D0FF"])
#define APP_COLOR_HL            ([UIColor colorWithHexString:@"#A6D0FF"])
#define APP_COLOR_DISABLE       ([UIColor colorWithHexString:@"#A6D0FF"])
#define APP_TitleButtonColor    ([UIColor colorWithHexString:@"#acdc79"])
#define APP_TitleButtonColorHL  ([UIColor colorWithHexString:@"#a5d374"])
#define APP_TitleButtonColorDis ([UIColor colorWithHexString:@"#c4d2b5"])
#define APP_TitleButtonColorSel ([UIColor colorWithHexString:@"#a5d374"])
#define APP_NavBgColor          ([UIColor colorWithHexString:@"#ffffff"])
#define APP_NavTitleColor       ([UIColor colorWithHexString:@"#8b8b8b"])
